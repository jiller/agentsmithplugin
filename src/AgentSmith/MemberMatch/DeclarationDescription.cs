...
namespace AgentSmith.MemberMatch
{
    public class DeclarationDescription
    {
        ...
        static DeclarationDescription()
        {
            ...
            _dict.Add(Declaration.EnumerationMember, new DeclarationDescription(Declaration.EnumerationMember, "Enumeration member", false, false, true, false, false, false));
            ...
            _dict.Add(Declaration.Parameter, new DeclarationDescription(Declaration.Parameter, "Parameter", false, false, true, false, false, true));
            ...
            _dict.Add(Declaration.Variable, new DeclarationDescription(Declaration.Variable, "Variable", true, false, true, false, false, true));
